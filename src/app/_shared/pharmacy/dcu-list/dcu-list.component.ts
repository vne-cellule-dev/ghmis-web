...
export class DcuListComponent implements OnInit {
  ...
  */
  ...
  getDcus() {
    ...
    this.dcuService.findAllByPage(data).subscribe(
      res => {
        if (res) {
          this.loading = false;
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.dcuService.disable(this.selectedItem).subscribe(result => {
          ...
          if (result) disableItem(this.dcus, result['id']);
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.dcuService.enable(this.selectedItem).subscribe(result => {
          ...
          if (result) enableItem(this.dcus, result['id']);
