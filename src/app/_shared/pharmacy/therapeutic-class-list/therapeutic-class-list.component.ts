...
export class TherapeuticClassListComponent implements OnInit {
  ...
  */
  ...
  getTheraClasses() {
    ...
    this.theraClassService.findAllByPage(data).subscribe(
      res => {
        if (res) {
          this.loading = false;
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.theraClassService.disable(this.selectedItem).subscribe(result => {
          ...
          if (result) disableItem(this.theraClasses, result['id']);
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.theraClassService.enable(this.selectedItem).subscribe(result => {
          ...
          if (result) enableItem(this.theraClasses, result['id']);
