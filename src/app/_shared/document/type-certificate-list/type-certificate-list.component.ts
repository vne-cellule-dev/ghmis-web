...
export class TypeCertificateListComponent implements OnInit {
  ...
  */
  ...
  getTypeCertificates() {
    ...
    this.typeCertificateService.findAllByPage(data).subscribe(
      res => {
        if (res) {
          this.loading = false;
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.typeCertificateService.disable(this.selectedItem).subscribe(result => {
          ...
          if (result) disableItem(this.typeCertificates, result['id']);
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.typeCertificateService.enable(this.selectedItem).subscribe(result => {
          ...
          if (result) enableItem(this.typeCertificates, result['id']);
